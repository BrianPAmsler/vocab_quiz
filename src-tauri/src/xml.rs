...
pub fn parse_xml_dictionary<T: std::io::Read>(readable: T, mode: ObscurityMode) -> Result<Dictionary, DictParseError> {
    let mut out = Vec::new();
    ...
    for child in &words.children {
        ...
        let wstruct = Word { text, pronunciation, definition, obscurity };
