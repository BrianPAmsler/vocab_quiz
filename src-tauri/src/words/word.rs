...
fn serialize_as_ecrypted_op<S: Serializer>(
...
pub struct Word {
    #[serde(
        serialize_with = "serialize_as_ecrypted",
        deserialize_with = "deserialize_as_ecrypted"
    )]
    pub text: String,
    #[serde(
        serialize_with = "serialize_as_ecrypted",
    ...
    #[serde(
        serialize_with = "serialize_as_ecrypted_op",
        deserialize_with = "deserialize_as_ecrypted_op"
    )]
